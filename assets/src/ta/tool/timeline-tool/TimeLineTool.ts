        ...
        switch (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineType) {
            case TimelineType.Spine:
                let timlineSpineName = Object.getOwnPropertyDescriptor(
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineSpine.timelineSpine.skeletonData.getAnimsEnum(),
                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                        .timelineSpineName
                ).value;
                this.arrayTimelineData[timelineIndex].timelineData[
                    timelineDataIndex
                ].timelineSpine.timelineSpine.setCompleteListener(() => {
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.timelineSpine.setCompleteListener(null);
                        if (
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                .isLoop === true
                        ) {
                        ...
                        if (
                            ...
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineSpine.timelineSpine.clearTracks();
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineSpine.timelineSpine.node.active = false;
                        }
                    });
                });
                this.scheduleOnce(() => {
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineSpine.timelineSpine.node.active = true;
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineSpine.timelineSpine.timeScale =
                    ...
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineSpine.timelineSpine.setAnimation(
                        0,
                        timlineSpineName,
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine.useSpine) {
                    let spineName = Object.getOwnPropertyDescriptor(
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.skeletonData.getAnimsEnum(),
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                            .spineSetupData.spineName
                    ).value;
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineSpine.spineSetupData.spine.setCompleteListener(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.setCompleteListener(null);
                        if (
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                .spineSetupData.isEndClose
                        ) {
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineSpine.spineSetupData.spine.clearTracks();

                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineSpine.spineSetupData.spine.node.active = false;
                        }
                    });
                    ...
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.node.active = true;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.clearTracks();
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.timeScale =
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineSpine.spineSetupData.timeScale;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.spineSetupData.spine.setAnimation(
                            0,
                            spineName,
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                .spineSetupData.isLoop
                        );
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine.useAnim) {
                    let animationName =
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                            .animSetupData.animation.clips[
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                .animSetupData.animationName
                        ].name;

                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineSpine.animSetupData.animation.play(animationName);
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine.useParticle) {
                    for (
                        let j = 0;
                        j <
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine.particleData
                            .length;
                        j++
                    ) {
                        switch (
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                .particleData[j].particleState
                        ) {
                            case ParticleState.Play:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineSpine.particleData[j].particle.ParticleClear();
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineSpine.particleData[j].particle.ParticlePlay(
                                    true,
                                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineSpine
                                        .particleData[j].delayTime
                                );
                                break;
                            case ParticleState.Stop:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineSpine.particleData[j].particle.ParticleStop();
                                break;
                        }
                    }
                }
            ...
            case TimelineType.Animation:
                let timelineAnimationName =
                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                        .timelineAnimation.clips[
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                ...
                this.arrayTimelineData[timelineIndex].timelineData[
                    timelineDataIndex
                ].timelineAnimation.timelineAnimation.on(
                    Animation.EventType.FINISHED,
                    () => {
                        this.checkTimelineEnd(timelineIndex);
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.timelineAnimation.off(Animation.EventType.FINISHED);
                    },
                    this
                );
                this.scheduleOnce(() => {
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineAnimation.timelineAnimation.play(timelineAnimationName);
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation.useSpine) {
                    let spineName = Object.getOwnPropertyDescriptor(
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.skeletonData.getAnimsEnum(),
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                            .spineSetupData.spineName
                    ).value;
                    ...
                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineAnimation.spineSetupData.spine.setCompleteListener(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.setCompleteListener(null);
                        if (
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                                .spineSetupData.isEndClose
                        ) {
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                                .spineSetupData.spine.clearTrack;
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineAnimation.spineSetupData.spine.node.active = false;
                        }
                    });
                    ...
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.node.active = true;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.clearTracks();
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.timeScale =
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineAnimation.spineSetupData.timeScale;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.spineSetupData.spine.setAnimation(
                            0,
                            spineName,
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation
                                .spineSetupData.isLoop
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation.useAnim) {
                    ...
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineAnimation.animSetupData.animation.play(animationName);
                    }, this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation.animSetupData.delayTime);
                }
                // 分支Particle播放設定
                if (
                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineAnimation.useParticle
                ) {
                    for (
                        let j = 0;
                        j <
                        ...
                        switch (
                            ...
                            case ParticleState.Play:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineAnimation.particleData[j].particle.ParticleClear();
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineAnimation.particleData[j].particle.ParticlePlay(
                                    true,
                                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex]
                                        .timelineAnimation.particleData[j].delayTime
                                );
                                break;
                            case ParticleState.Stop:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineAnimation.particleData[j].particle.ParticleStop();
                                break;
                        }
                    }
                }
            ...
            case TimelineType.Time:
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime.useSpine) {
                    let spineName = Object.getOwnPropertyDescriptor(
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.skeletonData.getAnimsEnum(),
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime
                            .spineSetupData.spineName
                    ).value;

                    this.arrayTimelineData[timelineIndex].timelineData[
                        timelineDataIndex
                    ].timelineTime.spineSetupData.spine.setCompleteListener(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.setCompleteListener(null);
                        if (
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime
                                .spineSetupData.isEndClose === true
                        ) {
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineTime.spineSetupData.spine.clearTracks();
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineTime.spineSetupData.spine.node.active = false;
                        }
                    });
                    ...
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.node.active = true;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.clearTracks();
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.timeScale =
                            this.arrayTimelineData[timelineIndex].timelineData[
                                timelineDataIndex
                            ].timelineTime.spineSetupData.timeScale;
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.spineSetupData.spine.setAnimation(
                            0,
                            spineName,
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime
                                .spineSetupData.isLoop
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime.useAnim) {
                    let animationName =
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime.animSetupData
                            .animation.clips[
                            this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime
                                .animSetupData.animationName
                        ].name;
                    ...
                    this.scheduleOnce(() => {
                        this.arrayTimelineData[timelineIndex].timelineData[
                            timelineDataIndex
                        ].timelineTime.animSetupData.animation.play(animationName);
                ...
                if (this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime.useParticle) {
                    for (
                        let j = 0;
                        j <
                        this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime.particleData
                            .length;
                        j++
                    ) {
                        switch (
                            ...
                            case ParticleState.Play:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineTime.particleData[j].particle.ParticleClear();
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineTime.particleData[j].particle.ParticlePlay(
                                    true,
                                    this.arrayTimelineData[timelineIndex].timelineData[timelineDataIndex].timelineTime
                                        .particleData[j].delayTime
                                );
                            ...
                            case ParticleState.Stop:
                                this.arrayTimelineData[timelineIndex].timelineData[
                                    timelineDataIndex
                                ].timelineTime.particleData[j].particle.ParticleStop();
                                break;
                        }
                    }
                }
        ...
        for (let index = 0; index < this.arrayTimelineData.length; index++) {
            ...
            for (let i = 0; i < this.arrayTimelineData[index].timelineData.length; i++) {
                switch (this.arrayTimelineData[index].timelineData[i].timelineType) {
                    case TimelineType.Spine:
                        this.arrayTimelineData[index].timelineData[i].timelineSpine.timelineSpine.setCompleteListener(
                            null
                        );
                        break;
                    default:
                ...
                switch (this.arrayTimelineData[index].timelineData[i].timelineType) {
                    case TimelineType.Spine:
                        ...
                        if (this.arrayTimelineData[index].timelineData[i].timelineSpine.useSpine) {
                            this.arrayTimelineData[index].timelineData[
                                i
                            ].timelineSpine.spineSetupData.spine?.clearTracks();
                            this.arrayTimelineData[index].timelineData[
                                i
                        ...
                        if (this.arrayTimelineData[index].timelineData[i].timelineSpine.useParticle) {
                            for (
                                let j = 0;
                                j < this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData.length;
                                j++
                            ) {
                                this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[
                                    j
                        ...
                        break;
                    case TimelineType.Animation:
                        this.arrayTimelineData[index].timelineData[i].timelineAnimation.timelineAnimation.off(
                            Animation.EventType.FINISHED
                        );
                        ...
                        if (this.arrayTimelineData[index].timelineData[i].timelineAnimation.useAnim) {
                            this.arrayTimelineData[index].timelineData[
                                i
                            ].timelineAnimation.animSetupData.animation?.stop();
                        }
                        if (this.arrayTimelineData[index].timelineData[i].timelineAnimation.useParticle) {
                            for (
                                let j = 0;
                                j < this.arrayTimelineData[index].timelineData[i].timelineAnimation.particleData.length;
                                j++
                            ) {
                                this.arrayTimelineData[index].timelineData[i].timelineAnimation.particleData[
                                    j
                                ].particle?.ParticleClear();
                            }
                        }
                    ...
                    case TimelineType.Time:
                        ...
                        if (this.arrayTimelineData[index].timelineData[i].timelineTime.useParticle) {
                            for (
                                let j = 0;
                                j < this.arrayTimelineData[index].timelineData[i].timelineTime.particleData.length;
                                j++
                            ) {
                                this.arrayTimelineData[index].timelineData[i].timelineTime.particleData[
                                    j
                                ].particle?.ParticleClear();
                            }
                        }
                ...
                for (let i = 0; i < this.arrayTimelineData[index].timelineData.length; i++) {
                    ...
                    if (this.arrayTimelineData[index].timelineData[i].timelineSpine.animSetupData.animation !== null) {
                        ...
                        for (
                            let j = 0;
                            j <
                            this.arrayTimelineData[index].timelineData[i].timelineSpine.animSetupData.animation.clips
                                .length;
                            j++
                        ) {
                            var name: string =
                                this.arrayTimelineData[index].timelineData[i].timelineSpine.animSetupData.animation
                                    .clips[j].name;
                            AnimEnum = Object.assign(AnimEnum, { [name]: j });
                        }
                        this._refreshSecEnum_AnimationName(
                            AnimEnum,
                            this.arrayTimelineData[index].timelineData[i].timelineSpine.animSetupData
                        );
                    } else {
                        this._refreshSecEnum_AnimationName(
                            { '<None>': 0 },
                    ...
                    for (
                        ...
                        if (
                            this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[j].particle !==
                            null
                        ) {
                            ...
                            this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[j].cycleTime =
                                this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[
                                    j
                                ].particle.LoopOverTime;
                            this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[
                                j
                            ].clearParticleTime =
                                this.arrayTimelineData[index].timelineData[i].timelineSpine.particleData[
                                    j
                                ].particle.ClearObjectTime;
                        }
                    }
                    ...
                    if (this.arrayTimelineData[index].timelineData[i].timelineAnimation.timelineAnimation !== null) {
                        ...
                        for (
                            let j = 0;
                            j <
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation.timelineAnimation.clips
                                .length;
                            j++
                        ) {
                            var name: string =
                        ...
                        this._refreshSecEnum_TimelineAnimationName(
                            AnimEnum,
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation
                        );
                    } else {
                        this._refreshSecEnum_TimelineAnimationName(
                            { '<None>': 0 },
                    ...
                    if (
                        this.arrayTimelineData[index].timelineData[i].timelineAnimation.animSetupData.animation !== null
                    ) {
                        var AnimEnum: object = {};
                        for (
                            let j = 0;
                            j <
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation.animSetupData.animation
                                .clips.length;
                            j++
                        ) {
                            var name: string =
                        ...
                        this._refreshSecEnum_AnimationName(
                            AnimEnum,
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation.animSetupData
                        );
                    } else {
                        this._refreshSecEnum_AnimationName(
                            { '<None>': 0 },
                    ...
                    for (
                        ...
                        if (
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation.particleData[j].particle !==
                            null
                        ) {
                            this.arrayTimelineData[index].timelineData[i].timelineAnimation.particleData[
                                j
                    ...
                    if (this.arrayTimelineData[index].timelineData[i].timelineTime.animSetupData.animation !== null) {
                        ...
                        for (
                            let j = 0;
                            j <
                            this.arrayTimelineData[index].timelineData[i].timelineTime.animSetupData.animation.clips
                                .length;
                            j++
                        ) {
                            var name: string =
                                this.arrayTimelineData[index].timelineData[i].timelineTime.animSetupData.animation
                                    .clips[j].name;
                            AnimEnum = Object.assign(AnimEnum, { [name]: j });
                        }
                        this._refreshSecEnum_AnimationName(
                            AnimEnum,
                            this.arrayTimelineData[index].timelineData[i].timelineTime.animSetupData
                        );
                    } else {
                        this._refreshSecEnum_AnimationName(
                            { '<None>': 0 },
                    ...
                    for (
                        ...
                        if (
                            this.arrayTimelineData[index].timelineData[i].timelineTime.particleData[j].particle !== null
                        ) {
